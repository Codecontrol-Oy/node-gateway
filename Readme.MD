...
var config = g.configure() //You can overwrite the settings with your own files if you wish, by using settings and routes params to configure method. By default it uses the files under the config directory
